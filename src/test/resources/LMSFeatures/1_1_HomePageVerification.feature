...
Feature: Home Page Verification
  ...
  Scenario: Validate login credentials with null password
   ...
   @TS_login_03
  Scenario Outline: Validate login with valid credentials through mouse click from Excel "<Sheetname>" and <RowNumber>
  Given Admin is in Home Page
  When Admin enter valid credentials  from excel "<Sheetname>" and <RowNumber> and clicks login button using mouse
